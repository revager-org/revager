...
public class OpenInvitationsDialogAction extends AbstractAction {

	/**
	 * Instantiates a new open invitations dialog action.
	 */
	...
	public void actionPerformed(ActionEvent e) {
		UI.getInstance().getCreateInvitationsDialog().clearInvitationsDialog();
		UI.getInstance().getCreateInvitationsDialog().setVisible(true);
	}
