...
public class ManageSeveritiesAction extends AbstractAction {

	/**
	 * Instantiates a new manage severities action.
	 */
	public ManageSeveritiesAction() {
		super();
	...
	public void actionPerformed(ActionEvent e) {
		UI.getInstance().getManageSeveritiesDialog().setVisible(true);
	}
