...
public class StrengthPopupWindowAction extends AbstractAction {

	private StrengthPopupWindow popupWindow = null;

	private ButtonClicked buttonClick = null;

	/**
	 * Instantiates a new strength popup window action.
	 * 
	 * @param popupWin
	 *            the popup win
	 * @param buttonClk
