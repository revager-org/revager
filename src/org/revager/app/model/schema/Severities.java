...
/**
 * This type lists all severities that can be defined for a finding. The order
 * of the severities define their importance. The first listed severity is more
 * important than the second and so on. The last listed severity is the least
 * important.
 * 
 * 
 * <p>
 * Java class for severitiesType complex type.
 * 
 * <p>
...
public class Severities {
	 ...
	 * <CODE>set</CODE> method for the severities property.
	 * 
	 * <p>
