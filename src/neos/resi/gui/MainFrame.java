...
import neos.resi.gui.UI.Status;
import neos.resi.gui.actions.ActionRegistry;
import neos.resi.gui.actions.ExitAction;
import neos.resi.gui.actions.LoadReviewAction;
import neos.resi.gui.actions.ManageSeveritiesAction;
import neos.resi.gui.actions.NewReviewAction;
import neos.resi.gui.actions.OpenAspectsManagerAction;
import neos.resi.gui.actions.OpenExpCSVDialogAction;
import neos.resi.gui.actions.OpenExpPDFDialogAction;
import neos.resi.gui.actions.OpenInvitationsDialogAction;
import neos.resi.gui.actions.OpenProtocolFrameAction;
import neos.resi.gui.actions.SaveReviewAction;
import neos.resi.gui.actions.SaveReviewAsAction;
import neos.resi.gui.actions.SelectModeAction;
...
import neos.resi.gui.helpers.MeetingsTreeRenderer;
import neos.resi.gui.helpers.TreeMeeting;
import neos.resi.gui.helpers.TreeProtocol;
import neos.resi.gui.models.AttendeeTableModel;
...
public class MainFrame extends AbstractFrame implements Observer {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see neos.resi.gui.AbstractFrame#switchToProgressMode()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see neos.resi.gui.AbstractFrame#switchToEditMode()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see neos.resi.gui.AbstractFrame#switchToClearMode()
	 */
	@Override
